...
export const metadata: Metadata = {
  title: "Hawk Buddy — AI Productivity Coach Case Study",
  description:
    "AI-powered productivity coach that aligns phone usage with personal goals — featuring goal discovery, app monitoring, and real-time feedback (Flutter + FastAPI + Cloudflare D1 + Gemini).",
  alternates: {
    canonical: "/projects/hawk-buddy",
  },
  openGraph: {
    type: "article",
    url: `${SITE.url}/projects/hawk-buddy`,
    title: "Hawk Buddy — AI Productivity Coach Case Study",
    description:
      "AI-powered productivity coach that aligns phone usage with personal goals. Flutter + FastAPI + Cloudflare D1 + Gemini.",
    images: [SITE.ogImage],
  },
};

const hawkBuddyJsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    {
      "@type": "SoftwareApplication",
      "@id": `${SITE.url}/projects/hawk-buddy#software`,
      name: "Hawk Buddy",
      alternateName: "Pro Buddy",
      url: `${SITE.url}/projects/hawk-buddy`,
      description:
        "Hawk Buddy is an AI-powered productivity coach that aligns phone usage with personal goals. It combines conversational goal discovery, real-time app monitoring, and Gemini-powered chat coaching, running on Flutter + FastAPI + Cloudflare D1.",
      ...
      codeRepository: "https://github.com/Samthesurf/pro_buddy",
      keywords: [
        "AI productivity app",
        "screen time coach",
        "Flutter app",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": `${SITE.url}/projects/hawk-buddy#breadcrumb`,
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "Hawk Buddy",
          item: `${SITE.url}/projects/hawk-buddy`,
        },
      ],
    },
  ],
...
const screenshotGroups: ScreenshotGroup[] = [
  {
    ...
    items: [
      {
        src: hawkBuddyDashboard,
        alt: "Hawk Buddy dashboard (cozy UI)",
        imageClassName: "object-cover",
      },
      {
        src: screenTimeImg,
        alt: "Hawk Buddy screen time breakdown",
        imageClassName: "object-cover",
      },
      {
        src: appConfigImg,
        alt: "Hawk Buddy selected apps / configuration screen",
        imageClassName: "object-cover",
      },
    ],
  },
  {
    ...
    items: [
      {
        src: hawkBuddyDashboardAlt,
        alt: "Hawk Buddy dashboard mock (blue background)",
        imageClassName: "object-cover",
      },
    ],
  },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#030303] text-slate-900 dark:text-white selection:bg-blue-500/30 selection:text-blue-200 overflow-hidden transition-colors duration-300">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(hawkBuddyJsonLd) }}
      />
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-6 text-lg md:text-xl text-slate-600 dark:text-gray-400 leading-relaxed max-w-3xl">
              An AI-powered productivity coach that aligns your phone usage with
              your goals — combining conversational goal discovery, real-time
              app monitoring, and supportive, non-intrusive feedback.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3 rounded-full border border-transparent bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-700 hover:to-amber-600 text-white font-bold transition-all shadow-lg hover:shadow-xl active:scale-95"
              >
                Download APK
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="rounded-3xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 p-8">
                ...
                <ul className="space-y-2 text-slate-600 dark:text-gray-400">
                  <li>
                    - Daily conversations that feel like a supportive mentor
                  </li>
              ...
              <div className="rounded-3xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 p-8">
                ...
                <ul className="space-y-2 text-slate-600 dark:text-gray-400">
                  ...
                  <li>
                    - AI-generated notification profile based on personality
                  </li>
                  <li>
                    - Habit & routine builder (focus blocks, morning routines)
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-3xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 p-8">
                ...
                <ul className="space-y-2 text-slate-600 dark:text-gray-400">
                  <li>
                    - AI app classification + goal alignment (Aligned / Neutral
                    / Misaligned)
                  </li>
          ...
          <section className="mt-20">
            <div className="rounded-3xl bg-gradient-to-br from-blue-600 to-blue-400 p-10 text-white">
              <h2 className="text-2xl md:text-3xl font-bold mb-3">
                Building a product that needs AI + real-time systems?
              </h2>
              <p className="text-white/90 max-w-2xl">
                I can help you design reliable AI flows, ship polished mobile
                UX, and deploy globally with edge-first infrastructure.
              </p>
