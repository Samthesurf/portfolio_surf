...
const PhoneFrame = ({
  ...
  <div
    className={`relative h-full w-full bg-[#121212] rounded-[2.5rem] shadow-xl border-[6px] border-[#1a1a1a] ring-1 ring-white/10 overflow-hidden ${className}`}
  >
    {/* Screen Content */}
...
const DesktopFrame = ({
  ...
  <div
    className={`relative w-full aspect-[16/10] bg-[#121212] rounded-xl shadow-2xl border-[6px] border-[#1a1a1a] ring-1 ring-white/10 overflow-hidden ${className}`}
  >
    {/* Window Controls */}
...
const FlutterIcon = () => (
  <svg viewBox="0 0 128 128" className="w-full h-full">
    ...
    <path
      fill="#42A5F5"
      d="M76.3 128h39.4L81.6 93.9l34.1-34.8H76.3L42.2 93.9z"
    />
...
const PythonIcon = () => (
  <svg viewBox="0 0 128 128" className="w-full h-full">
    ...
    <path
      fill="#366994"
      d="M463.554 119.285c0 10.213 8.308 17.201 19.62 17.201 11.312 0 19.62-6.988 19.62-17.201v-76.37h-19.62v74.565c0 .629-.629.749-.943.749-.313 0-.942-.12-.942-.749V42.915h-17.735v76.37z"
    />
  </svg>
);
...
interface ProjectBase {
  ...
  tags: string[];
  techStack: { name: string; icon: TechIcon }[];
  links: {
    github?: string;
    demo: string;
    site?: string;
...
interface MobileFanProject extends ProjectBase {
  layout: "mobile-fan";
  images: {
    ...
    desktop?: never;
    mobile?: never;
    desktopGallery?: never;
    mobileGallery?: never;
  };
}

interface DesktopMobileHybridProject extends ProjectBase {
...
const projects: Project[] = [
  {
    ...
    description:
      "AI learning platform that turns engineering course materials into quizzes, feedback, and study progress.",
    longDescription:
      "Engineering Hub helps engineering students study from the materials they already use. The app organizes courses by department and level, serves large PDFs through a fast Cloudflare-backed delivery layer, and uses Gemini to generate practice questions, evaluate theory answers, and give targeted feedback. I built it across Flutter, Firebase, Cloudflare, and Google Cloud with a Clean Architecture structure that keeps the learning, storage, and AI flows maintainable.",
    layout: "desktop-mobile-hybrid",
    images: {
      ...
      mobileGallery: [
        engineeringHubMobilePerformance,
        engineeringHubMobileStreaks,
        engineeringHubMobileOnboarding,
      ],
    },
    tags: [
      "Flutter",
    ...
    links: {
      ...
      apkDownload: "#",
      playStore:
        "https://play.google.com/store/apps/details?id=com.engineeringhub.engineeringhub",
  ...
  },
  {
    title: "Hawk Buddy",
    description:
      "AI-Powered Productivity Coach that Aligns Your Phone Usage with Your Goals",
    longDescription:
    ...
    links: {
      ...
      demo: "#",
      apkDownload:
        "https://pub-cf86be98216443899aa1280bf26bada2.r2.dev/hawk-buddy-v1-6.apk",
  ...
  },
  {
    ...
    description:
      "Client project for a student career conference, designed to help attendees understand the event, trust the brand, and buy tickets.",
    longDescription:
      "For Campus to Career 2.0, a student career conference in Nigeria, I built the public event platform end-to-end. The site gives attendees a clear picture of what the event is about, builds trust around the program, and moves them from interest to ticket purchase. It was built to drive sales.",
    layout: "desktop-mobile-hybrid",
    images: {
      desktop: campusDesktopHero,
      mobile: campusMobileHero,
      desktopGallery: [campusDesktopHero, campusDesktopActivities],
      mobileGallery: [
        campusMobileHero,
        campusMobileActivities,
        campusMobileHighlights,
      ],
    },
    tags: [
      "React",
    ...
    links: {
      github: "https://github.com/Samthesurf/Campus_Career",
      site: "https://campustocareer.ng",
      demo: "https://campustocareer.ng",
      caseStudy: "/projects/campus-career",
    },
    featured: true,
    hideMobileNotch: true,
  },
...
export default function ProjectsSection() {
  ...
  const lightboxProject = lightbox
    ? projects.find((p) => p.title === lightbox.projectTitle)
    : null;
  const lightboxGallery =
    lightbox && lightboxProject
      ? lightbox.kind === "desktop"
        ? (lightboxProject.images.desktopGallery ??
          (lightboxProject.images.desktop
            ? [lightboxProject.images.desktop]
            : []))
        : (lightboxProject.images.mobileGallery ??
          (lightboxProject.images.mobile
            ? [lightboxProject.images.mobile]
            : []))
      : [];
  const lightboxLen = lightboxGallery.length;
  const lightboxSrc =
    lightbox && lightboxLen > 0
      ? lightboxGallery[Math.min(lightbox.index, lightboxLen - 1)]
      : null;
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-gray-400 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            A showcase of my recent work, highlighting complex full-stack
        ...
        <div className="space-y-32">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div
                className={`w-full lg:w-1/2 flex justify-center perspective-1000 group ${index % 2 === 1 ? "lg:order-last" : ""}`}
              >
                <div className="relative w-full max-w-[600px] flex items-center justify-center">
                  {project.layout === "mobile-fan" && (
                    <div className="relative w-full max-w-[500px] h-[450px] md:h-[550px] flex items-center justify-center">
                      {/* Left Phone */}
                      <div
                        className="absolute left-1/2 top-1/2 w-[160px] md:w-[200px] aspect-[9/19]
                      ...
                      {/* Center Phone */}
                      <div
                        className="absolute left-1/2 top-1/2 w-[180px] md:w-[230px] aspect-[9/19]
                  ...
                  {project.layout === "desktop-mobile-hybrid" &&
                    (() => {
                      ...
                      const selection = selectedScreens[project.title] ?? {
                        desktop: 0,
                        mobile: 0,
                      };
                      ...
                      const activeDesktop =
                        desktopGallery[
                          Math.min(
                            selection.desktop,
                            Math.max(desktopGallery.length - 1, 0),
                          )
                        ] ?? project.images.desktop;
                      const activeMobile =
                        mobileGallery[
                          Math.min(
                            selection.mobile,
                            Math.max(mobileGallery.length - 1, 0),
                          )
                          ...
                          <div className="relative w-full flex items-center justify-center">
                            ...
                            >
                              <PhoneFrame
                                ...
                                hideNotch={project.hideMobileNotch}
                              />
                              <span className="sr-only">
                                Open mobile screenshots
                              </span>
                            </button>
                          </div>
                                  ...
                                  <div className="grid grid-cols-3 gap-2">
                                    {mobileGallery.map((src, i) => (
                                      <button
                                        ...
                                        className={`relative aspect-[9/19] rounded-xl overflow-hidden border transition-all ${
                                          selection.mobile === i
                                            ? "border-blue-500/60 ring-2 ring-blue-500/30"
                                            : "border-slate-200/70 dark:border-white/10 hover:border-blue-500/40"
                                        }`}
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  ...
                  {project.links.site && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      className={
                        project.title === "Campus to Career"
                          ? "inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white font-bold transition-all shadow-lg hover:shadow-xl active:scale-95"
                          : "inline-flex items-center gap-2 px-6 py-3 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold hover:bg-slate-800 dark:hover:bg-gray-100 transition-all active:scale-95"
                      }
                    >
                      <div className="w-5 h-5">
                        <GlobeIcon />
                  ...
                  {project.links.apkDownload &&
                    project.links.apkDownload !== "#" && (
                      <a
                        ...
                        } text-white font-bold transition-all shadow-lg hover:shadow-xl active:scale-95`}
                      >
                        <DownloadIcon />
                ...
                {lightboxLen > 0 && (
                  <>
                    ...
                    <span className="text-white/70">
                      {Math.min(lightbox.index + 1, lightboxLen)} /{" "}
                      {lightboxLen}
                    </span>
                  </>
                )}
                ...
                <button
                  ...
                  onClick={() =>
                    setLightbox((prev) => {
                      if (!prev) return prev;
                      const nextIndex =
                        (prev.index - 1 + lightboxLen) % lightboxLen;
                      return { ...prev, index: nextIndex };
                    })
                  }
