...
const OracleCloudIcon = () => (
    <svg viewBox="0 0.3 31.4 19.8" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
...
const DockerIcon = () => (
    <svg viewBox="-.557 117.607 598.543 423.631" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        <g fill="#0091e2">
...
const skills = [
    ...
    { name: "Oracle Cloud", icon: OracleCloudIcon },
...
export default function SkillsSection() {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-blue-100/50 dark:via-blue-950/5 to-transparent pointer-events-none" />
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-7 gap-6 md:gap-8 mb-16">
                    {skills.map((skill, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="relative w-16 h-16 md:w-20 md:h-20 mb-3 p-3 md:p-4 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-sm transition-all duration-300 group-hover:scale-110 group-hover:bg-slate-200 dark:group-hover:bg-white/10 group-hover:border-slate-300 dark:group-hover:border-white/20 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]">
                                    <IconComponent />
                                </div>
                                <span className="text-slate-600 dark:text-gray-400 text-sm md:text-base font-medium text-center group-hover:text-slate-900 dark:group-hover:text-white transition-colors duration-300">
                                    {skill.name}
                                </span>
                            </div>
                        );
